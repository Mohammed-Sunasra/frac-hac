...
class Preprocessor(object):
    """
    Handles tokenization, stemming and other pre-processing steps with the dataset
    """

    def __init__(self, data):
        self.data = data
        self.answer = self.process(self.data.questions.answer)
        self.questions = self.process(self.data.questions.question)
        self.reviews = self.process(self.data.reviews.reviewText)
        self.summary = self.process(self.data.reviews.summary)

    def tokenize(self, corpus):
        """
        Divides each doc of corpus into tokens
        :return:
        :rtype:
        """
        pass
    ...
    def process(self, corpus):
        """
        Pre processes data with various methods
        :return:
        :rtype:
        """
        pass
